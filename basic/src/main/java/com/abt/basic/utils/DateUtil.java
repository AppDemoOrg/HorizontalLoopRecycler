...
public class DateUtil {
     ...
     * @return 星期
     */
    public static final com.abt.basic.utils.Week getWeek(String date) {
        com.abt.basic.utils.Week week = null;
        DateStyle dateStyle = getDateStyle(date);
        if (dateStyle != null) {
            Date myDate = stringToDate(date, dateStyle);
            week = getWeek(myDate);
     ...
     * @return 星期
     */
    public static final com.abt.basic.utils.Week getWeek(Date date) {
        com.abt.basic.utils.Week week = null;
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
        ...
        switch (weekNumber) {
            case 0:
                week = com.abt.basic.utils.Week.SUNDAY;
                break;
            case 1:
                week = com.abt.basic.utils.Week.MONDAY;
                break;
            case 2:
                week = com.abt.basic.utils.Week.TUESDAY;
                break;
            case 3:
                week = com.abt.basic.utils.Week.WEDNESDAY;
                break;
            case 4:
                week = com.abt.basic.utils.Week.THURSDAY;
                break;
            case 5:
                week = com.abt.basic.utils.Week.FRIDAY;
                break;
            case 6:
                week = com.abt.basic.utils.Week.SATURDAY;
                break;
        }
        return week;
    }
    ...
    public static final com.abt.basic.utils.Week getWeek(int weekNumber) {
        com.abt.basic.utils.Week week = null;
        switch (weekNumber) {
            case 0:
                week = com.abt.basic.utils.Week.SUNDAY;
    ...
    private static final boolean isSameDay(long time) {
        com.abt.basic.utils.TimeInfo timeInfo = getTodayStartAndEndTime();
        return time > timeInfo.startTime && time < timeInfo.endTime;
    }

    private static final boolean isYesterday(long time) {
        com.abt.basic.utils.TimeInfo timeInfo = getYesterdayStartAndEndTime();
        return time > timeInfo.startTime && time < timeInfo.endTime;
    }

    public static final com.abt.basic.utils.TimeInfo getYesterdayStartAndEndTime() {
        ...
        com.abt.basic.utils.TimeInfo timeInfo = new com.abt.basic.utils.TimeInfo();
    ...
    public static final com.abt.basic.utils.TimeInfo getTodayStartAndEndTime() {
        Calendar sCalendar = Calendar.getInstance();
        sCalendar.set(11, 0);
        sCalendar.set(12, 0);
        sCalendar.set(13, 0);
